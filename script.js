const translations = {
  ru: {
    nav_services:'Услуги', nav_portfolio:'Портфолио', nav_experience:'Опыт', nav_contacts:'Контакты',
  ...
  en: {
    nav_services:'Services', nav_portfolio:'Portfolio', nav_experience:'Experience', nav_contacts:'Contacts',
